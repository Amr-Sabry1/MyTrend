          ...
          <div className="col-md-8">
            ...
            <div className="row g-3" id="show">
              ...
              <div class="col-md-3">
                ...
                <img
                  src={
                    "https://image.tmdb.org/t/p/w500" + peoplew[0]?.poster_path
                  }
              ...
              <div class="col-md-3">
                ...
                <img
                  src={
                    "https://image.tmdb.org/t/p/w500" + peoplew[1]?.poster_path
                  }
                  class="w-100 rounded-2"
                  alt=""
                />{" "}
              ...
              <div class="col-md-3">
                ...
                <img
                  src={
                    "https://image.tmdb.org/t/p/w500" + peoplew[2]?.poster_path
                  }
                  class="w-100 rounded-2"
                  alt=""
                />{" "}
              ...
              <div class="col-md-3">
                ...
                <img
                  src={
                    "https://image.tmdb.org/t/p/w500" + peoplew[3]?.poster_path
                  }
                  class="w-100 rounded-2"
                  alt=""
                />{" "}
